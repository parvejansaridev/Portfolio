...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-border mt-10">
      <div className="section !py-12 grid sm:grid-cols-3 gap-10">
        <div>
          <a href="#home" className="flex items-center gap-2 font-display font-semibold text-lg">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-teal-400 to-teal-600 text-white font-mono font-bold text-sm">
              PA
            </span>
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              rel="noreferrer"
              aria-label="GitHub"
              className="grid h-10 w-10 place-items-center rounded-full border border-border text-muted hover:text-teal-400 hover:border-teal-400/50 transition-colors"
            >
              <FiGithub />
            </a>
            <a
      ...
      <div className="border-t border-border py-5 text-center text-xs text-muted font-mono">
