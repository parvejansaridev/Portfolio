      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        {certifications.map((cert, i) => (
          <motion.div
            ...
            whileHover={{ y: -6 }}
            className="group relative rounded-2xl border border-white/10 glass p-6 hover:border-teal-400/30 transition-all duration-300 flex flex-col justify-between"
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between gap-4 mb-4">
                <span className="grid h-12 w-12 place-items-center rounded-xl bg-gradient-to-br from-teal-400 to-teal-600 text-[#06140F] text-xl shadow-lg shadow-teal-500/15">
                  <FiAward />
                </span>
            ...
            <div className="relative z-10 mt-6 pt-4 border-t border-white/5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {cert.skills.map((skill) => (
                  <span
                    key={skill}
                    className="flex items-center gap-1 font-mono text-[10px] sm:text-[11px] px-2.5 py-1 rounded-full bg-white/[0.03] border border-white/5 text-teal-300"
                  >
